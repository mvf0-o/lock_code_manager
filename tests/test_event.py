...
async def test_event_entity(
    ...
    assert state.attributes[ATTR_STATE] == LockState.UNLOCKED.value
    ...
    assert state.attributes[ATTR_FROM] == LockState.LOCKED.value
    assert state.attributes[ATTR_TO] == LockState.UNLOCKED.value
